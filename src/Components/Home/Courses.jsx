            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">
                    {courses.map((course) => (
                        ...
                        >
                            {/* Course image */}
                            <div className="h-40 sm:h-40 lg:h-60 relative bg-[#490271] border-b-6 rounded-b-lg rounded-t-4xl border-yellow-500 flex items-center justify-center overflow-hidden">
                                <img
                                    alt={course.title}
                                    src={course.image}
                            ...
                            <div className="px-3 pt-3 pb-0">
                                ...
                                <div className="flex items-center justify-between">
                                    <span className="bg-yellow-400 text-[#490271] px-6 py-1 rounded-lg text-xs sm:text-sm font-bold">
                                        {course.category}
                                    </span>

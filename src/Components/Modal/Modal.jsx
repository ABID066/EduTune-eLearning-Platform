...
import {FaBook, FaCertificate, FaCheck, FaClipboard, FaCube, FaArrowLeft} from "react-icons/fa";
...
const Modal = ({onClose}) => {
    ...
    const handleCourseSelect = (index) => {
        ...
        // Show details on mobile/tablet after selection
        setShowDetails(true);
    };
            ...
            <div className="fixed inset-0 flex items-center justify-center z-50 p-1">
                <div className="bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl w-full max-w-5xl relative overflow-hidden border border-white/20">
                    ...
                    <div className="lg:hidden">
                        {/* Course List View (Mobile/Tablet) */}
                                ...
                                <div className="flex flex-col gap-3 max-h-[70vh] overflow-y-auto">
                                    {courses.map((course, index) => (
                                        <button
                                            ...
                                            className="border-2 border-purple-900 text-[#3D0C59] text-left px-4 py-3 rounded-full text-sm font-medium transition-all duration-200 bg-white border border-purple-200 hover:border-purple-400 hover:bg-purple-50"
                                        >
                                            {course}
                                        </button>
                                    ))}
                        ...
                        {/* Course Details View (Mobile/Tablet) */}
                        <div className={`${showDetails ? 'block' : 'hidden'}`}>
                            <div className="p-6 bg-white/10 relative max-h-[90vh] overflow-y-auto">
                                {/* Back Button */}
                                <button
                                ...
                                {selectedCourse !== null && (
                                    <div className="mb-4 p-3 bg-[#FFBB00] text-[#3D0C59] rounded-full text-sm font-medium">
                                ...
                                <div className="relative z-10">
                                    ...
                                    {/* Course Image - Mobile positioned */}
                                    <div className="mb-6 flex justify-center">
                                        <img src={img2} alt=""/>
                                    </div>

                                    {/* Course Details Grid */}
                                    <div className="grid grid-cols-1 gap-2 mb-6 mx-10 max-w-md">
                                        {[
                                            ...
                                            <div key={index} className="flex items-center text-md text-gray-900">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 mb-6">
                                        <button className="bg-gradient-to-r font-bold from-gray-800 to-gray-900 text-white px-6 py-3 rounded-xl font-medium hover:from-gray-900 hover:to-black transition-all shadow-lg hover:shadow-xl flex-1">
                                            Join batch
                                        </button>
                                        <button className="flex items-center justify-center gap-2 border-2 border-gray-300 px-6 py-3 rounded-xl font-medium hover:border-gray-400 hover:bg-gray-50 transition-all flex-1">
